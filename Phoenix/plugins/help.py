...
from Phoenix import Phoenix, CMD_HELP
from Phoenix.helpers.utility import split_list

heading = "──「 **{PHOENIX USERBOT}** 」──\n"


@Phoenix.on_message(filters.command("help", ".") & filters.me)
