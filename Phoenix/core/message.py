...
class Message(RawMessage):
    """ 
    Modded Message Class For Phoenix
 
    """
    def __init__(self,
                 client: Union['_client.Phoenix', '_client.PhoenixBot'],
    ...
    @classmethod
    def parse(cls, client: Union['_client.Phoenix', '_client.PhoenixBot'],
    ...
    @property
    def client(self) -> Union['_client.Phoenix', '_client.PhoenixBot']:
        """ returns client """
        return self._client
